<template>
	<view class="tui-tag" :hover-class="hover ? 'tui-tag-opacity' : ''" :hover-stay-time="150" :class="[originLeft ? 'tui-origin-left' : '', originRight ? 'tui-origin-right' : '', getClassName(shape, plain), getTypeClass(type, plain)]"
