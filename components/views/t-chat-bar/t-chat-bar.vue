	...
	<view @touchmove.stop.prevent>
		<view class="tui-reply-tabbar" :style="{ paddingBottom: `${keyboardHeight}px` }">
			<view class="tui-chat-tabbar">
				...
				<view class="tui-chat-voice_btn" hover-class="tui-opacity" :hover-stay-time="150" v-if="isVoice">按住 说话
				</view>
				<view class="tui-send-box">
					...
					<view class="tui-btn-send" v-if="content" :style="{ color: color }" hover-class="tui-opacity"
			...
			<view class="tui-reply-more">
				<view class="tui-face-box" v-if="showIndex == 2">
					...
					<view class="tui-delete-face_box">
						<view class="tui-delete-keybord" :class="{ 'tui-opacity': !content }"><text
